...
class Server(threading.Thread):
            ...
            if data:
                try:
                    ...
                    if decrypted_message['action'] == "logout":
                        ...
                        if decrypted_message['action'] == self.action:
                            self.combo += 1
                            print(f"++ DANCE CORRECT {self.combo} COMBO!!!!!")
                        else:
                            print("X DANCE WRONG")
                            self.combo = 0
                            print("COMBO BROKEN!!!!!!!!!")
    ...
    def set_next_action(self):
        ...
        print('CURRENT POSITION: {0}'.format(self.dancer_positions))
